...
import { Youtube, Play, Loader2, Twitter, Linkedin } from 'lucide-react'
import {
  SiInstagram, SiYoutube, SiGithub, SiGitlab,
  ...
  SiKofi, SiBuymeacoffee, SiSnapchat, SiDiscord, SiTelegram, SiWhatsapp, SiTiktok,
} from 'react-icons/si'
...
const SOCIAL_PLATFORMS: Record<string, { icon: IconType | LucideIcon; brandColor: string; buildUrl: (h: string) => string }> = {
  x: { icon: Twitter, brandColor: '#000000', buildUrl: (h) => `https://x.com/${h}` },
  ...
  linkedin: { icon: Linkedin, brandColor: '#0A66C2', buildUrl: (h) => `https://linkedin.com/in/${h}` },
        ...
        <div className="w-full h-full flex flex-col p-2 md:p-3">
          <div className="flex items-center gap-2 mb-2 pb-2 border-b border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-[8px] text-gray-400">Mes dernières vidéos</span>
            </div>
          </div>
...
// Profile data
const profile = {"name":"𝑀’🇪🇸","bio":"Haute École de la Province de Liège\nÉtudiant en infographie 2D & 3D","avatarUrl":"/assets/avatar.png","theme":"light","primaryColor":"blue","showBranding":false,"analytics":{"enabled":false,"supabaseUrl":""},"socialAccounts":[{"platform":"instagram","handle":"__m.pk44"},{"platform":"youtube","handle":"mpcreation_yt"},{"platform":"website","handle":"https://www.mp-creation.be/"}],"showSocialInHeader":true,"showFollowerCount":false,"backgroundColor":"#F7F7F7","openGraph":{"title":"Mon hub - MP Creation","description":"Découvrez mon portfolio ici !"}}
const blocks: BlockData[] = [{"id":"keg01xuof","type":"LINK","title":"Mon portfolio","content":"https://mp-creation.be","colSpan":3,"rowSpan":3,"color":"bg-white","textColor":"text-gray-900","gridColumn":1,"gridRow":1,"imageUrl":"/assets/block-keg01xuof.png","subtext":"Visite toutes mes créations ici →"},{"id":"2cum514pb","type":"LINK","title":"Ma page Instagram","content":"https://www.instagram.com/__m.pk44/","colSpan":3,"rowSpan":3,"color":"bg-white","textColor":"text-gray-900","gridColumn":4,"gridRow":1,"subtext":"@__m.pk44","imageUrl":"/assets/block-2cum514pb.png"},{"id":"xvshdtxsk","type":"SOCIAL","title":"YouTube","content":"","colSpan":6,"rowSpan":6,"color":"bg-white","textColor":"text-gray-900","gridColumn":1,"gridRow":4,"socialPlatform":"youtube","socialHandle":"","channelId":"UCHKnVXqusFyOxuJqDRnWg_Q","youtubeMode":"grid","subtext":"test"}]
